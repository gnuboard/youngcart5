...
<div id="scp_list" class="new_win">
    ...
    <li>
        ...
        <div>
            ...
            <span class="pd_date"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo substr($row['cp_start'], 2, 8); ?> ~ <i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo substr($row['cp_end'], 2, 8); ?></span>
        </div>
    </li>
    <?php
    }
