        ...
        if( !$exist_order['cnt'] ){
            ...
            //상품주문
                ...
                if($od && isset($data['it_id']) && !empty($data['it_id'])) {
                    ...
                    if( !empty($params['ss_direct']) && !empty($params['ss_cart_direct'])  ){
                        set_session('ss_direct', $params['ss_direct']);
                        set_session('ss_cart_direct', $params['ss_cart_direct']);
                    } else if ( $params['ss_cart_id'] ){
                        set_session('ss_cart_id', $params['ss_cart_id']);
                    }

                    $_POST['ss_direct'] = $params['ss_direct'] = '';
                    $_POST['ss_cart_direct'] = $params['ss_cart_direct'] = '';
                    $_POST['ss_cart_id'] = $params['ss_cart_id'] = '';
